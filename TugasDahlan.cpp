...
int main(){
	...
	//menampilkan matriks x menggunakan perulangan while
		cout << "MATRIKS X :"<<endl;
	int i=0;
	do{
		cout<<a1c[i] << " | ";
	...
	//menampilkan matriks r menggunakan perulangan while
	cout << endl<<endl;
		cout << "MATRIKS R :"<<endl;
	int l=0;
	do{
	...
	//menampilkan matriks w menggunakan perulangan while	
	cout <<endl << endl;
	cout << "BOBOT W :"<<endl;
	int O=0;
	do{
